...
export const EBOOK_AND_MUSIC_RELEASE_REGEX =
	/(^\s*\d+\s*[-.]?(?=\s)|\b(?:19|20)\d{2}\b|\b\d{5,}\b|\d+k\b|['']s\b|\{.*?}|\b\d+\s?kbps\b|\bkbps\b|\bm4b\b|\bpdf\b|\bdocx\b|\bepub\b|\bmobi\b|\bazw3\b|\bm4a\b|\bmp3\b|\bflac\b|\sWEB\b|audiobook\b|\bebook\b|\bNew\b|[a\W]+(novela?|saga|series)|(Read|Narrated)?\W?By\W\w+\W*\w*\b)/gi;
